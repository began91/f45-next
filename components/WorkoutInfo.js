...
export default function WorkoutInfo(props) {
    ...
    const handleChange = e => {
        ...
        setWorkouts({
            ...workouts,
            [props.view]: { ...workout, stationList: newStationList },
        });
    };
    ...
    return !workout.stationList ? (
        ...
        <div id="workoutInfo">
            ...
            <div id="workoutStyle" className="workout-info-data">
                {workout.displayStyle}
            </div>
            ...
            <ol id="stationList">
                {props.view === 'custom' ? (
                    <div>
                        Here&apos;s the most recent {workout.displayStyle}{' '}
                        workout:
                    </div>
                ) : (
                    ''
